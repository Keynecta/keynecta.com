...
content_blocks:
  - _bookshop_name: hero
    heading: Our Process
    body: >-
      Keynecta’s Safety Culture Scoring System (patent pending) collects data
      and helps you make informed safety decisions. Access the resources and
      training you need, measure relevant metrics, input data for compliance,
      and begin establishing a culture of safety with our online dashboard.
    image_1:
  ...
  - _bookshop_name: intro
    ...
    body: >-
      Organizations closely monitor metrics like output, quality, labor, and
      budgets. Why not do the same with safety?


      Keynecta's Safety Culture Scoring Dashboard informs organizations of
      their  safety performance. And guides where to take the safety program by
      establishing attainable and measurable goals.


      Stop guessing when comes to safety and let well-informed decisions take
      your safety program to the next level. And notice the impact a
      safety-oriented culture will have on an organization's overall operations.
    button:
      enabled: false
      button_url:
      button_text:
  ...
  - _bookshop_name: two-columns
    columns:
      - heading: Complete Online System
        body: >-
          Easily access your organization's personalized online safety
          dashboard. All employees can access their own safety dashboard with
          trainings, procedures, inspection forms, and more. Accessible wherever
